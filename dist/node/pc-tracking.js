(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("component-emitter"));
	else if(typeof define === 'function' && define.amd)
		define(["component-emitter"], factory);
	else {
...
var _optOut = __webpack_require__(14);
...
// Accessors
_core2.default.prototype.writeKey = function (str) {
  if (!arguments.length) return this.config.writeKey;
  this.config.writeKey = str ? String(str) : null;
  return this;
};

_core2.default.prototype.referrerPolicy = function (str) {
...
var _deferEvents = __webpack_require__(23);
...
var _unique = __webpack_require__(20);
...
var _https = __webpack_require__(19);
...
var _cacheBrowser = __webpack_require__(22);
